<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="MoodyFoody.User.Registration" %>
                   ...
                   <div class="row">
                        ...
                        <div>
                         ...
                         <div>
                             ...
                             <asp:RequiredFieldValidator ID="rfvMobile" runat="server" ErrorMessage="Mobile Number is Required" ControlToValidate="txtMobile"
                                 ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                             <asp:RegularExpressionValidator ID="revMobile" runat="server" ErrorMessage="Mobile No. Must Have 10 digits" ForeColor="Red" Display="Dynamic"
                    ...
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revPostCode" runat="server" ErrorMessage="Post Code Must Have 6 digits" ForeColor="Red" Display="Dynamic"
                                 SetFocusOnError="true" ValidationExpression="^[0-9]{6}$"
                            ...
                            <asp:TextBox ID="txtPostCode" runat="server" CssClass ="form-control" Placeholder="Enter PostCode" 
                                ToolTip="Username" TextMode="Number"></asp:TextBox>
                        </div>
